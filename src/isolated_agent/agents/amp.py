"""Sourcegraph Amp coding agent adapter."""
import os
...
class AmpAgent(Agent):
    """Agent adapter for Sourcegraph Amp CLI."""

    name: str = "amp"

    def __init__(
        self,
        api_key_env: str = "AMP_API_KEY",
    ...
    def get_shim_config(self) -> ShimConfig:
        return ShimConfig(
            ...
            env_vars={
                ...
                "HOME": "/workspace/.amp-home",
                "TMPDIR": "/workspace/.tmp",
            },
            shim_bwrap=False,
            home_dir="/workspace/.amp-home",
            tmp_dir="/workspace/.tmp",
            forward_local=["/usr/local/bin/amp", "/usr/bin/node"],
        )
