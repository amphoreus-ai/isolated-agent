"""OpenCode terminal AI coding agent adapter."""
import os
...
class OpenCodeAgent(Agent):
    """Agent adapter for OpenCode CLI."""
    ...
    def get_shim_config(self) -> ShimConfig:
        return ShimConfig(
            ...
            shim_bwrap=False,
            home_dir="/workspace/.opencode-home",
            tmp_dir="/workspace/.tmp",
            forward_local=["/usr/local/bin/opencode", "/usr/bin/node"],
        )
